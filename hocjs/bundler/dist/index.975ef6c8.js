...
const App = ()=>{
    return `<h1>Hello F8: ${(0, _momentDefault.default)().format("DD/MM/YYYY HH:mm:ss")}</h1>`;
};

},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","moment":"318Kc"}],"gkKU3":[function(require,module,exports) {
...
},{}],"318Kc":[function(require,module,exports) {
//! moment.js
//! version : 2.29.4
